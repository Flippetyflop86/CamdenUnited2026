                            ...
                            {pinMode === "set" ? (
                                <div className="space-y-3">
                                    ...
                                    <Button 
                                        type="button"
                                        onClick={() => {
                                            const text = `Hi Coach, please verify me for training check-in on ClubFlow. My name is ${selectedPlayer.firstName} ${selectedPlayer.lastName}. My activation code is: ${otpCode}`;
