...
import { Sparkles, ArrowRight, Shield, Activity, Users, FileText, Database, Layers } from "lucide-react";

export default function LandingPage() {
    const [activeTab, setActiveTab] = useState<"dashboard" | "matchday" | "squad" | "recruitment" | "development" | "attendance">("dashboard");

    const tabs = [
        { id: "dashboard", label: "Dashboard Overview", src: "/dashboard-screenshot.png", desc: "Your club's mission control. Real-time availability rates, dynamic priorities, and league standings consolidated into one clean dashboard." },
        { id: "matchday", label: "Matchday XI", src: "/matchday-xi-screenshot.png", desc: "Drag, drop, and define. Lock in formations, manage the substitutes bench, and generate automated matchday squad notifications." },
        { id: "squad", label: "Squad Depth", src: "/squad-management-screenshot.png", desc: "Long-term roster planning. Map primary and secondary roles, side-specific defensive positions, and track medical status updates." },
        { id: "recruitment", label: "Recruitment", src: "/squad-management-screenshot.png", desc: "Keep track of active trialists, target profiles, and custom scout reports to build the future of the club." },
        { id: "development", label: "Player Development", src: "/training-tracking-screenshot.png", desc: "Individual progression tracking. Keep records of age metrics, homegrown status, and custom performance notes." },
        { id: "attendance", label: "Attendance Tracker", src: "/training-tracking-screenshot.png", desc: "Track attendance rates across matches and sessions to get real data on player dedication." },
    ] as const;
    ...
    return (
        <div className="bg-[#030712] text-slate-100 min-h-screen font-sans selection:bg-emerald-500/30 selection:text-emerald-400 overflow-x-hidden antialiased">
                ...
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-12">
                        <Link href="/" className="flex items-center gap-3">
                            <span className="h-7 w-7 rounded bg-emerald-500 flex items-center justify-center font-black text-slate-950 text-sm">CF</span>
            ...
            <header className="relative pt-40 pb-32 md:pt-48 md:pb-44 flex flex-col items-center text-center px-6 overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-[90%] mt-24 px-4 md:px-0">
                    <div className="rounded-2xl overflow-hidden border border-slate-900 shadow-[0_0_80px_-10px_rgba(16,185,129,0.08)] bg-slate-950/90">
                        <img 
            ...
            <section id="tour" className="py-32 max-w-[92%] mx-auto px-6 space-y-16">
                <div className="text-center space-y-4 max-w-2xl mx-auto">
                    <span className="text-xs font-black uppercase text-emerald-400 tracking-wider">Product Tour</span>
                    <h2 className="text-3xl md:text-5xl font-black text-white leading-tight">Explore the platform.</h2>
                    <p className="text-lg text-slate-400 leading-relaxed">
                        Navigate through the modular workspaces that align matchday tactics, recruitment logs, and roster depth.
                    </p>
                </div>
                ...
                <div className="rounded-2xl overflow-hidden border border-slate-900/80 bg-slate-950/40 shadow-2xl">
                    <img 
            ...
            {/* Deep Feature Redesign sections following standard Stripe pattern */}
            <section id="workflow" className="py-32 max-w-6xl mx-auto px-6 space-y-36">
                ...
                <div className="grid gap-12 lg:grid-cols-2 items-center">
                    ...
                    <div className="rounded-xl overflow-hidden border border-slate-900 shadow-2xl">
                        <img src="/matchday-xi-screenshot.png" alt="Matchday XI Tactics Board" className="w-full object-cover" />
                    </div>
                </div>

                {/* Visual Focus: Squad Planning */}
                <div className="grid gap-12 lg:grid-cols-2 items-center">
                    <div className="rounded-xl overflow-hidden border border-slate-900 shadow-2xl lg:order-first order-last">
                        <img src="/squad-management-screenshot.png" alt="Squad Management & Planning Center" className="w-full object-cover" />
                    </div>
                    <div className="space-y-6">
                ...
                {/* Visual Focus: Training and Logs */}
                <div className="grid gap-12 lg:grid-cols-2 items-center">
                    <div className="space-y-6">
                        <span className="text-xs font-black uppercase text-emerald-400 tracking-wider">03 Attendance Heatmaps</span>
                        <h2 className="text-3xl md:text-5.5xl font-black text-white leading-tight">Track physical stats and dedication.</h2>
                        <p className="text-lg text-slate-400 leading-relaxed">
                            Say goodbye to paper logs. Log training sessions in seconds, monitor team-wide participation rates, and trace individual player attendance metrics with clean interactive data.
                        </p>
                    </div>
                    <div className="rounded-xl overflow-hidden border border-slate-900 shadow-2xl">
                        <img src="/training-tracking-screenshot.png" alt="Training Tracking & Sessions Overview" className="w-full object-cover" />
                    </div>
                </div>
